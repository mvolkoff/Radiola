...
namespace Radiola.Services.Pandora.Common
{
    internal class Cryptography
    {
        internal static long DecryptSyncTime(string s)
        {
            ...
            {
                //Logger<Crypto>.Log(LogLevel.Error, "Failed to parse sync time '" + b + "': " + e + "\r\nRaw:" + s);
                throw;
            }
        }

        public static Blowfish in_key = new Blowfish(PandoraConstants.CRYPT_IN_KEY);
        public static Blowfish out_key = new Blowfish(PandoraConstants.CRYPT_OUT_KEY);
